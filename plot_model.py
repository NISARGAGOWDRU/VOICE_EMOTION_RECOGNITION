...
class LivePredictions:
    ...
    def generate_emotional_voice(self, emotion):
        ...
        if emotion == 'happy':
            ...
            engine.setProperty('rate', 90)   # Slow down the speech
            engine.setProperty('volume', 0.7)  # Reduce volume
        elif emotion == 'angry':
            engine.setProperty('rate', 180)  # Increase speed
            engine.setProperty('volume', 1.0)  # Full volume
        elif emotion in ['fearful', 'disgust']:
            engine.setProperty('rate', 100)  # Moderate speed
            engine.setProperty('volume', 0.5)  # Lower volume
        else:
            engine.setProperty('rate', 120)  # Default rate
            engine.setProperty('volume', 1.0)  # Full volume

        # Use the text based on predicted emotion
